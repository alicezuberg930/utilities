...
const fNumber = (number: InputValue) => {
    if (!number && number !== 0) return ''
    return Number(number).toLocaleString('en-US')
}

const fCurrency = (number: InputValue) => {
    if (!number && number !== 0) return ''
...
const fPercent = (number: InputValue) => {
    if (!number && number !== 0) return ''
...
const fShortenNumber = (number: InputValue) => {
    if (!number && number !== 0) return ''
    const value = Number(number)
...
export { fNumber, fCurrency, fPercent, fShortenNumber, fData }